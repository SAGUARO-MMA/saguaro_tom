...
class DesiDr1Q3C(models.Model):
    ...
    redshift_warning = models.BigIntegerField(blank=True, null=True)
    site = models.TextField(blank=True, null=True)
    instrument = models.TextField(blank=True, null=True)
    specid = models.BigIntegerField(blank=True, null=True)
    specprimary = models.TextField(blank=True, null=True)
    telescope = models.TextField(blank=True, null=True)
    data_release = models.TextField(blank=True, null=True)
    targetid = models.BigIntegerField(blank=True, null=True)
