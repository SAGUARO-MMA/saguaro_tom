...
POSTGRES_DB2 = ''       # name of the Postgres database for catalogs
POSTGRES_HOST2 = ''     # hostname or IP address of the Postgres database server for catalogs
POSTGRES_PASSWORD2 = '' # password for the Postgres database for catalogs
POSTGRES_PORT2 = 5432   # port number for the Postgres database for catalogs
POSTGRES_USER2 = ''     # username for the Postgres database for catalogs
